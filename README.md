...
Research, positioning, logos, a mascot, posts and motion videos for [Namzilabs](https://namzilabs.co), *the numbers between your tools, with the working shown.*
...
|---|---|
| [**preview.html**](preview.html) | The preview and download page: every post, video, logo and sticker, with copy-caption buttons and ZIP downloads (see [below](#the-preview-page)) |
| [**STRATEGY.md**](STRATEGY.md) | The plan: positioning, who we talk to (in order), pillars, cadence, hooks, CTAs, the first 60 days, and the claims rules |
...
| [**brand/**](brand/) | Ten logo concepts (SVG and PNG), the recommended mark, [Namzi the mascot](brand/mascot/), and the [brand kit](brand/BRAND_KIT.md) |
| [**posts/**](posts/) | 24 ready-to-post pieces for Instagram and X. Each has its images, captions, X copy, alt text and a claims check |
| [**videos/**](videos/) | 10 smooth motion videos at 60fps, with captions ([videos/README](videos/README.md)) |
...
**Recommended: 01 · Between.** Two tools, and the number in the overlap. **06 · Namzi** is its social twin: the same lens with a face, for avatars and stickers. Every concept has SVGs (colour, white, ink, app icons, lockups) and a 1024px profile picture. See the [boards](brand/logos/boards/) and the [brand kit](brand/BRAND_KIT.md).
...
| <a href="videos/10-launch-receipt/launch-receipt-9x16.mp4"><img src="videos/10-launch-receipt/poster.jpg" width="200"></a><br>**10** The launch screenshot vs the receipt · 16s | | |

All ten are rendered frame by frame at 60fps (1080×1920; the sting is 1080×1080) and are silent by design. Add a trending instrumental in-app. Captions are in [videos/README](videos/README.md).
...
- **Published copy:** the same page is published as a private Artifact. Its videos are web-compressed copies (CRF 23) so the whole page fits in one version. The full-quality masters are here in the repo.
...
| `tools/` | Render stills, render video, sample frames, build logos, export the mascot, build the preview page |
