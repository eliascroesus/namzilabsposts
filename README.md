...
| [**highlights/**](highlights/) ✨ | Eleven Instagram highlights in the order a visitor needs them (Start here, five features, four use cases, FAQ): 63 stories, the sticker for each, and the covers: one clean icon per highlight, in four colourways ([highlights/README](highlights/README.md)) |
| [**screenshots/**](screenshots/) 📸 | Real screens of the product, for the highlights and posts: where to upload them (privately), how to take them, the shot list for every highlight, and what must never be on them ([screenshots/README](screenshots/README.md)) |
