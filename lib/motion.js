...
(function () {
  ...
  const LOGO = `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="64" height="64" rx="16" fill="#14141c"/><path d="M32 20.4a13 13 0 0 1 0 23.2a13 13 0 0 1 0-23.2Z" fill="#fff"/><circle cx="26" cy="32" r="13" fill="none" stroke="#fff" stroke-width="3.6"/><circle cx="38" cy="32" r="13" fill="none" stroke="#fff" stroke-width="3.6"/></svg>`;
  ...
  window.NZ = Object.assign(window.NZ || {}, { ease, bezier, spring, Timeline, counter, fmt, splitWords, hydrateMarks, hydrateLogos, mount, still, LOGO });
})();
