...
```text
Zapier connects your apps. Namzilabs connects your numbers.
```

## Taglines

Short lines for profile names, banners, thumbnails, ads and the site. The first is the primary one.

**Primary** · 25/60 characters  
Everywhere: banners, the site, the lockup.
...
When the reader already has too many dashboards.

```text
Every tool. Every customer. One true number.
```

**The funnel** · 37/60 characters  
...
**The sales floor** · 35/60 characters  
Coaching and info-product sales teams.

```text
Booked is a hope. Held is a number.
```

**The money** · 35/60 characters  
Founders and owners.

```text
Know exactly where the money leaks.
```

**Playful** · 30/60 characters  
Pairs with Namzi.
...
Founders and ops people who already use Zapier.

```text
Zapier connects your apps. Namzilabs connects your numbers.
```

**Double counting** · 26/60 characters  
Anyone whose numbers don't match.

```text
Count every customer once.
```

**Monday** · 39/60 characters  
Whoever builds the weekly report by hand.

```text
Your Monday report, done before Monday.
```
...
```text
Short videos on the numbers that run a business, and where your funnel really breaks.
```
...
For namzilabs.co and anywhere a link unfurls.

**Hero headline** · 25/60 characters
...
**Secondary button** · 16/30 characters

```text
See how it works
```

**Meta title** · 46/60 characters

```text
Namzilabs: all your business data in one place
```
...
One ask per post. Pick the one that fits.
...
```text
Start free at namzilabs.co (no card).
```

**Comment keyword**

```text
Comment SHOWUP and I'll send you the exact setup.
```

**Send it**

```text
Send this to the person who builds the Monday report.
```
...
**HELD (cost per held meeting)**

```text
Here's cost per held meeting 👇
...
**LEAK (where the funnel breaks)**

```text
Here's how to find your leak 👇
...
```text
Here's your launch in one number 👇
...
```text
Which one first? Reply with one:
• show rate
...
**FIRST10 (design partners)**

```text
Thank you 🙏 We're setting up the first 10 teams by hand, with the founder.
