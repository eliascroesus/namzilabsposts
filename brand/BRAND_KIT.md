...
**Instagram highlights:** eleven, always in this order: Start here; the features (Any KPI, Funnel, Count once, Receipts, Connect); the use cases (Sales teams, Agencies, Creators, E-com); FAQ. Two cover sets, never mixed on one profile: **3D**, Namzi in a small lit scene per highlight ([`lib/namzi3d.js`](../lib/namzi3d.js)), and **icons**, drawn on one 96-unit grid with a 6-unit stroke, round caps and exactly one accent ([`lib/hlicons.js`](../lib/hlicons.js)), in blue, ink, paper or each highlight's own colour. The stories, stickers and covers are in [`highlights/`](../highlights/README.md).
